...
def test_product_rule_simple():
    ...
    expected1 = "cos(x) * x + sin(x)"
    expected2 = "sin(x) + cos(x) * x"
    expected3 = "sin(x) + x * cos(x)"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"


def test_product_rule_with_exponent():
    """Tests product rule with exponent: (x^2 * exp(x))'."""
    result = get_derived_string("x^2 * exp(x)")
    expected1 = "exp(x) * (2x + x ^ 2)"
    expected2 = "2exp(x) * x + exp(x) * x ^ 2"
    expected3 = "exp(x) * x ^ 2 + 2exp(x) * x"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_product_rule_polynomial_times_trig():
    ...
    expected1 = "(1 + x ^ 2) * cos(x) + 2sin(x) * x"
    expected2 = "2sin(x) * x + (1 + x ^ 2) * cos(x)"
    expected3 = "(x ^ 2 + 1) * cos(x) + 2x * sin(x)"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_quotient_rule_complex():
    ...
    result = get_derived_string("x / sin(x)")
    expected1 = "(-cos(x) * x + sin(x)) / ((sin(x)) ^ 2)"
    expected2 = "(sin(x) - cos(x) * x) / ((sin(x)) ^ 2)"
    expected3 = "(sin(x) - x * cos(x)) / (sin(x) ^ 2)"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_chain_rule_power_of_function():
    ...
    expected1 = "2cos(x) * sin(x)"
    expected2 = "2sin(x) * cos(x)"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
...
def test_chain_rule_complex_exponent():
    ...
    expected1 = "3exp(x ^ 3) * x ^ 2"
    expected2 = "3x ^ 2 * exp(x ^ 3)"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
...
def test_chain_rule_nested_trig():
    ...
    expected1 = "-cos(cos(x)) * sin(x)"
    expected2 = "-sin(x) * cos(cos(x))"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
...
def test_chain_rule_exp_of_sin():
    ...
    expected1 = "cos(x) * exp(sin(x))"
    expected2 = "exp(sin(x)) * cos(x)"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
...
def test_chain_rule_sqrt_of_expression():
    ...
    expected1 = "x / sqrt(1 + x ^ 2)"
    expected2 = "x / sqrt(x ^ 2 + 1)"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
...
def test_power_rule_fractional_exponent():
    ...
    expected1 = "0.5 * (x ^ -0.5)"
    expected2 = "0.5 / (x ^ 0.5)"
    expected3 = "0.5 / sqrt(x)"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1}, {expected2}, or {expected3}, got: {result}"
...
def test_power_rule_with_chain():
    ...
    expected3 = "6 * (2x) ^ 2"
    expected4 = "24 * x ^ 2"
    assert result == expected1 or result == expected2 or result == expected3 or result == expected4, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_derivative_of_log():
    ...
    expected = "0.43429448190325176 / x"
    assert result == expected, f"Expected: {expected}, got: {result}"
...
def test_derivative_of_constant_base_variable_exponent():
    ...
    expected = "0.69314718055994532 ^ x"
    assert result == expected, f"Expected: {expected}, got: {result}"
...
def test_complex_expression_product_quotient():
    ...
    expected = "((cos(x)) ^ 2 * x ^ 2 + (sin(x)) ^ 2 * x ^ 2 + 2cos(x) * sin(x) * x) / ((cos(x)) ^ 2)"
    assert result == expected, f"Expected: {expected}, got: {result}"
...
def test_complex_nested_expression():
    ...
    expected1 = "2cos(x ^ 2) * exp(sin(x ^ 2)) * x"
    expected2 = "2x * cos(x ^ 2) * exp(sin(x ^ 2))"
    expected3 = "exp(sin(x ^ 2)) * 2x * cos(x ^ 2)"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_complex_polynomial_in_trig():
    ...
    expected1 = "cos(2x + x ^ 3) * (3x^2 + 2)"
    expected2 = "(3x^2 + 2) * cos(2x + x ^ 3)"
    expected3 = "2cos(2x + x ^ 3) + 3cos(2x + x ^ 3) * x ^ 2"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_complex_quotient_with_chain():
    ...
    expected1 = "(-sin(x ^ 2) + 2cos(x ^ 2) * x ^ 2) / (x ^ 2)"
    expected2 = "(2cos(x ^ 2) * x ^ 2 - sin(x ^ 2)) / (x ^ 2)"
    expected3 = "(2x * cos(x ^ 2) - sin(x ^ 2) / x) / x"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_logarithmic_diff_x_to_x():
    ...
    expected1 = "x ^ x * (1 + ln(x))"
    expected2 = "x ^ x + x ^ x * ln(x)"
    expected3 = "ln(x) * x ^ x + x ^ x"
    assert result == expected1 or result == expected2 or result == expected3, \
        f"Expected: {expected1} or permutation, got: {result}"
...
def test_triple_nested_function():
    ...
    expected1 = "-cos(cos(x)) * sin(x) / sin(cos(x))"
    expected2 = "(-sin(x) * cos(cos(x))) / sin(cos(x))"
    assert result == expected1 or result == expected2, f"Expected: {expected1} or {expected2}, got: {result}"
